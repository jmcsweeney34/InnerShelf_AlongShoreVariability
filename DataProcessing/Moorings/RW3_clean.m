...
RW3=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/RW3/ptsal_tchain_RW3.mat');
rw3=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/RW3/RW3A_AQ.mat');

RW3.mab=RW3.TCHAIN.ZBEDT;
RW3.mab(1)=RW3.mab(2)+2;

%% Need to convert from local time to UTC!! 
% added this line 9/19/19 after disovering the times didn't make sense.
% whoops! 

RW3.TCHAIN.time_dnum30=RW3.TCHAIN.time_dnum30+(7/24); 
RW3.TCHAIN.time_dnum60=RW3.TCHAIN.time_dnum60+(7/24); 

rw3.AQ.time_dnum=rw3.AQ.time_dnum+(7/24); 

%% %% Transform to uniform grid in z 
% pcolorjw(RW3.TCHAIN.time_dnum30,RW3.TCHAIN.ZBEDT,RW3.TCHAIN.TEMP30')

dn=datenum(2017,9,1,0,0,0):1/(24*60):datenum(2017,10,16,0,0,0);
mab=(0:0.5:19.5)'; 

u=interp2(rw3.AQ.time_dnum,rw3.AQ.Zbed,rw3.AQ.Ue',dn,mab);
v=interp2(rw3.AQ.time_dnum,rw3.AQ.Zbed,rw3.AQ.Un',dn,mab);
t=interp2(RW3.TCHAIN.time_dnum30,RW3.mab,RW3.TCHAIN.TEMP30',dn,mab);
...
D=interp1(tide.dn,tide.wl+19,dn);
D=pl33tn(D,1/60,2)';
...
if 0
    ...
    '/Volumes/InnerShelf1/JackAnalysis/AlongShelfVariability/CleanUpMoorings/RW3_clean' ];

    save([anadir 'RW3.mat'],'Usig','Vsig','Tsig','dn_sig','H',...
