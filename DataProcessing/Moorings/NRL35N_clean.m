...
NRL35N=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/NRL35N/T.mat');

%% Fix NRL temp - 50S  

NRL35N.dn=datenum(2017,9,6):60/(24*60*60):datenum(2017,11,6);
NRL35N.mab=flipud(NRL35N.T.zab);

NRL35N.temp(1:length(NRL35N.mab),1:length(NRL35N.dn))=nan;
NRL35N.temp(1,:)=interp1(datenum(NRL35N.T.datenum.z6),NRL35N.T.temp.z6,NRL35N.dn);
NRL35N.temp(2,:)=interp1(datenum(NRL35N.T.datenum.z9),NRL35N.T.temp.z9,NRL35N.dn);
NRL35N.temp(3,:)=interp1(datenum(NRL35N.T.datenum.z12),NRL35N.T.temp.z12,NRL35N.dn);
NRL35N.temp(4,:)=interp1(datenum(NRL35N.T.datenum.z15),NRL35N.T.temp.z15,NRL35N.dn);
NRL35N.temp(5,:)=interp1(datenum(NRL35N.T.datenum.z18),NRL35N.T.temp.z18,NRL35N.dn);
NRL35N.temp(6,:)=interp1(datenum(NRL35N.T.datenum.z21),NRL35N.T.temp.z21,NRL35N.dn);
NRL35N.temp(7,:)=interp1(datenum(NRL35N.T.datenum.z24),NRL35N.T.temp.z24,NRL35N.dn);
NRL35N.temp(8,:)=interp1(datenum(NRL35N.T.datenum.z27),NRL35N.T.temp.z27,NRL35N.dn);

xtemp=datenum(NRL35N.T.datenum.z30); ytemp=NRL35N.T.temp.z30;
[x, index] = unique(xtemp); 
NRL35N.temp(9,:)=interp1(x,ytemp(index),NRL35N.dn);

% % clever way to identify good data; but want bad data haha 
% i=(NRL35N.dn>datenum(2017,9,9,18,1,0)).*(NRL35N.dn<datenum(2017,10,31,3,0,0));
% i(i==0)=nan;

i=find(NRL35N.dn<datenum(2017,9,8,17,50,0) | NRL35N.dn>datenum(2017,11,3,14,27,0));
NRL35N.dn(i)=[];
NRL35N.temp(:,i)=[];
...
dn=datenum(2017,9,8,0,0,0):1/(24*60):datenum(2017,11,4,0,0,0);
mab=(0:0.5:36)'; 

t=interp2(NRL35N.dn,NRL35N.mab,NRL35N.temp,dn,mab);
...
%% 
if 0
    save([anadir 'NRL35N.mat'],'Tsig','dn_sig','H',...
        't','dn','mab','subtidal','-v7.3');
    disp('NRL35N.mat saved!');
end
