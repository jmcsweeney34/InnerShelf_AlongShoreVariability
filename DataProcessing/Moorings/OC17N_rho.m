...
%% Download Data 
OC17N=load([moordir 'OC17N-T_30s.mat']);
...
Temp=interp2(OC17N.dn,OC17N.mab,OC17N.temp,dn,mab);
...
figure; 
subplot(2,1,1);
pcolorjw(OC17N.dn,OC17N.mab,OC17N.temp); colorbar 
xaxis(dn(1),dn(end));
yaxis(mab(1),mab(end));
...
D=interp1(tide.dn,tide.wl+17,dn);
...
clearvars -except dn OC17N mab temp sal rho H sig Tsig Rho_sig dn_sig anadir D

if 0
    save([anadir 'OC17N_TempRho_zandsig.mat']);
end 
