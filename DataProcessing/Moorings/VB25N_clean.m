...
VB25N=load('/Volumes/InnerShelf1/JackProcessing/Level2/VB25N_T_60s.mat');
vb25n=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/VB25N/VB25N_A_ADCP_1min.mat');
...
u=interp2(vb25n.DN,vb25n.Z,vb25n.U,dn,mab);
v=interp2(vb25n.DN,vb25n.Z,vb25n.V,dn,mab);
w=interp2(vb25n.DN,vb25n.Z,vb25n.W,dn,mab);
t=interp2(VB25N.dn,VB25N.mab,VB25N.temp,dn,mab);
...
D=interp1(tide.dn,tide.wl+25,dn);
D=pl33tn(D,1/60,2)';
...
%% 
if 0
    save([anadir 'VB25N.mat'],'Usig','Vsig','Wsig','Tsig','dn_sig','H',...
        'u','v','w','t','dn','mab','subtidal','-v7.3');    
    disp('VB25N.mat saved!');
end
