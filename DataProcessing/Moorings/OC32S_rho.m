...
%% Download Data 
OC32S=load([moordir 'OC32S-T_30s.mat']);
...
Temp=interp2(OC32S.dn,OC32S.mab,OC32S.temp,dn,mab);
Temp(6:65,:)=fillmissing(Temp(6:65,:),'linear');
...
figure; 
subplot(2,1,1);
pcolorjw(OC32S.dn,OC32S.mab,OC32S.temp); colorbar 
xaxis(dn(1),dn(end));
yaxis(mab(1),mab(end));
...
clearvars -except dn OC3SN mab temp sal rho sig Tsig Rho_sig dn_sig anadir H D

if 0
    save([anadir 'OC32S_TempRho_zandsig.mat']);
end 
