...
VB30N=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/VB30N/VB30N-T_30s.mat');
vb30N=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/VB30N/VB30N-A_20s.mat');


%% Clean data

vb30N.dn=datenum(2017,9,10,0,0,0):60/(60*60*24):datenum(2017,11,1,0,0,0);
vb30N.mab=vb30N.zab;

% a mistake on Colosi's part - an easy fix though 
vb30N.u=vb30N.u(1:25,:);
vb30N.v=vb30N.v(1:25,:);

% Make new mask - the other one kept too much bad data  
perbad=20;
vb30N.z=meshgrid(vb30N.zab,vb30N.datenum)';
vb30N.maskjm=double(vb30N.z<(30-(30*perbad/100)));
vb30N.maskjm(vb30N.maskjm==0)=nan;

tempo=pl66tn(vb30N.u.*vb30N.maskjm,20/3600,60/3600)'; %1 min filter, 20 second data 
vb30N.ui=interp2(meshgrid(vb30N.datenum,vb30N.mab),meshgrid(vb30N.mab,vb30N.datenum)',tempo,meshgrid(vb30N.dn,vb30N.mab),meshgrid(vb30N.mab,vb30N.dn)');
clear tempo 
tempo=pl66tn(vb30N.v.*vb30N.maskjm,20/3600,60/3600)'; %1 min filter, 20 second data 
vb30N.vi=interp2(meshgrid(vb30N.datenum,vb30N.mab),meshgrid(vb30N.mab,vb30N.datenum)',tempo,meshgrid(vb30N.dn,vb30N.mab),meshgrid(vb30N.mab,vb30N.dn)');
clear tempo 
tempo=pl66tn(vb30N.w.*vb30N.maskjm,20/3600,60/3600)'; %1 min filter, 20 second data 
vb30N.wi=interp2(meshgrid(vb30N.datenum,vb30N.mab),meshgrid(vb30N.mab,vb30N.datenum)',tempo,meshgrid(vb30N.dn,vb30N.mab),meshgrid(vb30N.mab,vb30N.dn)');
clear tempo 
...
u=interp2(vb30N.dn,vb30N.mab,vb30N.ui,dn,mab);
v=interp2(vb30N.dn,vb30N.mab,vb30N.vi,dn,mab);
w=interp2(vb30N.dn,vb30N.mab,vb30N.wi,dn,mab);


% pcolorjw(repmat(VB30N.datenum,8,1)',-VB30N.pres+30,VB30N.temp); colorbar

t=u.*nan; 
for i=1:length(dn)
    ii=findnearest_JACK(VB30N.datenum,dn(i));
    if abs(dn(i)-VB30N.datenum(ii)) < 0.000001
        t(:,i)=interp1(-VB30N.pres(ii,:)+30,VB30N.temp(ii,:),mab);
    end 
end
...
%% 
if 0
    save([anadir 'VB30N.mat'],'Usig','Vsig','Wsig','Tsig','dn_sig','H',...
        'u','v','w','t','dn','mab','subtidal','-v7.3');    
    disp('VB30N.mat saved!');
end
