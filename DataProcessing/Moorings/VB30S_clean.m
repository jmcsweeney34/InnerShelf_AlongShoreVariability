...
VB30S=load('/Volumes/InnerShelf1/JackProcessing/Level2/VB30S-T_60s.mat');
vb30s=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/VB30S/VB30S_A_ADCP_1min.mat');
...
u=interp2(vb30s.DN,vb30s.Z,vb30s.U,dn,mab);
v=interp2(vb30s.DN,vb30s.Z,vb30s.V,dn,mab);
w=interp2(vb30s.DN,vb30s.Z,vb30s.W,dn,mab);
t=interp2(VB30S.dn,VB30S.mab,VB30S.temp,dn,mab);
...
%% 
if 0
    save([anadir 'VB30S.mat'],'Usig','Vsig','Wsig','Tsig','dn_sig','H',...
        'u','v','w','t','dn','mab','subtidal','-v7.3');    
    disp('VB30S.mat saved!');
end
