...
VB25S=load('/Volumes/InnerShelf1/JackProcessing/Level2/VB25S-T_60s.mat');


%% %% Transform to uniform grid in z 

dn=datenum(2017,9,7,0,0,0):1/(24*60):datenum(2017,11,1,0,0,0);
mab=(0:1:26)'; 

t=interp2(VB25S.dn,VB25S.mab,VB25S.temp,dn,mab);
...
%% 
if 0
    save([anadir 'VB25S.mat'],'Tsig','dn_sig','H',...
       't','dn','mab','subtidal','-v7.3');    
    disp('VB25S.mat saved!');
end
