...
%% Download Data 
tempo=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/OC25SB-T/OC25SB-T_deploy1_30sec.mat');
OC25SB.lon=-tempo.grid30s.lon;
OC25SB.lat=tempo.grid30s.lat;
OC25SB.temp=tempo.grid30s.temp;
OC25SB.mab=25-tempo.grid30s.pos;
OC25SB.dn=tempo.grid30s.datenum;

ii=[1 2 3 4 7 9 10 12 18 20 22];
OC25SB.temp(ii,:)=[]; OC25SB.mab(ii)=[];
clear tempo

tempo=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/OC25SB-T/OC25SB-T_deploy2_30sec.mat');
OC25SBb.lon=-tempo.grid30s.lon;
OC25SBb.lat=tempo.grid30s.lat;
OC25SBb.temp=tempo.grid30s.temp;
OC25SBb.mab=25-tempo.grid30s.pos;
OC25SBb.dn=tempo.grid30s.datenum;
ii=[1 2 3 4 7 9 10 12 18 20 22];
OC25SBb.temp(ii,:)=[]; OC25SBb.mab(ii)=[];
clear tempo
...
Temp1=interp2(OC25SB.dn,OC25SB.mab,fillmissing(OC25SB.temp,'linear'),dn,mab);
Temp2=interp2(OC25SBb.dn,OC25SBb.mab,fillmissing(OC25SBb.temp,'linear'),dn,mab);
...
figure; 
subplot(2,1,1);
pcolorjw(OC25SB.dn,OC25SB.mab,OC25SB.temp); colorbar 
hold on 
pcolorjw(OC25SBb.dn,OC25SBb.mab,OC25SBb.temp);
xaxis(dn(1),dn(end));
yaxis(mab(1),mab(end));
...
clearvars -except dn mab OC25SB OC25SBb temp anadir veldir
...
clearvars -except dn OC25SB OC25SBb mab temp sal rho H sig Tsig Rho_sig dn_sig anadir D

if 0
    save([anadir 'OC25SB_TempRho_zandsig.mat']);
end 
