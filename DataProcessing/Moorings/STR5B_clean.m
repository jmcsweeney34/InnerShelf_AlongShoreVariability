...
STR5B=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/STR5B/ptsal_tchain_STR5_B.mat');
str5b=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/STR5B/STR5_AQ.mat');

STR5B.mab=STR5B.TCHAIN.ZBEDT;
STR5B.mab(1)=STR5B.mab(2)+abs(nanmean(diff(STR5B.TCHAIN.ZBEDT)));

%% Need to convert from local time to UTC!! 
% added this line 9/19/19 after disovering the times didn't make sense.
% whoops! 
STR5B.TCHAIN.time_dnum=STR5B.TCHAIN.time_dnum+(7/24); 
str5b.AQ.time_dnum=str5b.AQ.time_dnum+(7/24); 


%% %% Transform to uniform grid in z 
% pcolorjw(STR5B.TCHAIN.time_dnum,STR5B.mab,STR5B.TCHAIN.TEMP')

dn=datenum(2017,9,1,0,0,0):1/(24*60):datenum(2017,10,15,0,0,0);
mab=(0:0.25:10)'; 

% there was surface data that wasn't flagged appropriately 
u=interp2(str5b.AQ.time_dnum,str5b.AQ.Zbed,str5b.AQ.Ue',dn,mab);
v=interp2(str5b.AQ.time_dnum,str5b.AQ.Zbed,str5b.AQ.Un',dn,mab);
w=interp2(str5b.AQ.time_dnum,str5b.AQ.Zbed,str5b.AQ.W',dn,mab);
t=interp2(STR5B.TCHAIN.time_dnum,STR5B.mab,STR5B.TCHAIN.TEMP',dn,mab);
...
if 1
    ...
    '/Volumes/InnerShelf1/JackAnalysis/AlongShelfVariability/CleanUpMoorings/STR5B_clean' ];

    save([anadir 'STR5B.mat'],'Usig','Vsig','Wsig','Tsig','dn_sig','H',...
        'u','v','w','t','dn','sig','mab','subtidal','Rho_sig','Psig','-v7.3');
    disp('STR5B.mat saved!');
end
