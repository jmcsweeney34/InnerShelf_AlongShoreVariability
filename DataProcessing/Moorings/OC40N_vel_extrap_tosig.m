...
%% Download Data 
oc40n=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/OC40N-A/OC40N_1min_JMM.mat');


%% Check that north is true north 
% % % as of 10/5/18 I'm not sure yet -- NEED to come back to this 

%% Remove bad data 
oc40n.u(:,1:1449)=nan; oc40n.u(:,40253:end)=nan;
oc40n.v(:,1:1449)=nan; oc40n.v(:,40253:end)=nan;
oc40n.w5(:,1:1449)=nan; oc40n.w5(:,40253:end)=nan;

tide=load('/Volumes/InnerShelf1/NOAA_Buoy_Data/SanLuis_9412110/SanLuisWaterLevel_msl.mat');
surf=interp1(tide.dn,pl33tn(tide.wl+35,6/60,1),oc40n.dn);
surf=fillmissing(surf,'linear');

perbad=10;
oc40n.z=meshgrid(oc40n.mab,oc40n.dn)';
oc40n.surf=meshgrid(surf,oc40n.mab);

oc40n.maskjm=double(oc40n.z<(oc40n.surf-(oc40n.surf*perbad/100)));
oc40n.maskjm(oc40n.maskjm==0)=nan;

oc40n.u(isnan(oc40n.maskjm))=nan;
oc40n.v(isnan(oc40n.maskjm))=nan;
oc40n.w5(isnan(oc40n.maskjm))=nan;
...
u=interp2(oc40n.dn,oc40n.mab,oc40n.u,dn,mab);
v=interp2(oc40n.dn,oc40n.mab,oc40n.v,dn,mab);
w=interp2(oc40n.dn,oc40n.mab,oc40n.w5,dn,mab);
...
subplot(1,2,1);
plot(oc40n.u(:,ii),oc40n.mab,'.','color',[0.5 0.5 0.5],'markersize',15);
hold on 
...
if 1
    ...
    close all
    figure('position',[440   116   325   682]);
    plot(oc40n.w5(:,ii),oc40n.mab,'.','color',[0.8 0.8 0.8],'markersize',40);
    hold on
...
if 0
    save([anadir 'oc40nvel_zandsig.mat']);
end 
