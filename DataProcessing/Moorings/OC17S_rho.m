...
%% Download Data 
OC17S=load([moordir 'OC17S-T_30s.mat']);
...
Temp=interp2(OC17S.dn,OC17S.mab,OC17S.temp,dn,mab);
...
clearvars -except dn OC17S mab temp sal rho H sig Tsig Rho_sig dn_sig anadir D

if 0
    save([anadir 'OC17S_TempRho_zandsig.mat']);
end 
