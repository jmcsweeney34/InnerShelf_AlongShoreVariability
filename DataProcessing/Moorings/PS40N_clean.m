...
PS40N=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/PS40N/PS40N-T_30s.mat');
ps40n=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/PS40N/PS40N-A_20s.mat');
...
ps40n.dn=datenum(2017,9,9,19,0,0):60/(60*60*24):datenum(2017,11,1,6,0,0);
ps40n.mab=ps40n.zab;

% a mistake on Colosi's part - an easy fix though 
ps40n.u=ps40n.u(1:17,:);
ps40n.v=ps40n.v(1:17,:);

% Make new mask - the other one kept too much bad data  
perbad=10;
ps40n.z=meshgrid(ps40n.zab,ps40n.datenum)';
ps40n.maskjm=double(ps40n.z<(40-(40*perbad/100)));
ps40n.maskjm(ps40n.maskjm==0)=nan;

tempo=pl66tn(ps40n.u.*ps40n.maskjm,20/3600,60/3600)'; %1 min filter, 20 second data 
ps40n.ui=interp2(meshgrid(ps40n.datenum,ps40n.mab),meshgrid(ps40n.mab,ps40n.datenum)',tempo,meshgrid(ps40n.dn,ps40n.mab),meshgrid(ps40n.mab,ps40n.dn)');
clear tempo 
tempo=pl66tn(ps40n.v.*ps40n.maskjm,20/3600,60/3600)'; %1 min filter, 20 second data 
ps40n.vi=interp2(meshgrid(ps40n.datenum,ps40n.mab),meshgrid(ps40n.mab,ps40n.datenum)',tempo,meshgrid(ps40n.dn,ps40n.mab),meshgrid(ps40n.mab,ps40n.dn)');
clear tempo 
tempo=pl66tn(ps40n.w.*ps40n.maskjm,20/3600,60/3600)'; %1 min filter, 20 second data 
ps40n.wi=interp2(meshgrid(ps40n.datenum,ps40n.mab),meshgrid(ps40n.mab,ps40n.datenum)',tempo,meshgrid(ps40n.dn,ps40n.mab),meshgrid(ps40n.mab,ps40n.dn)');
clear tempo 


% pcolorjw(repmat(PS40N.datenum,9,1)',-PS40N.pres+40,PS40N.temp); colorbar
...
u=interp2(ps40n.dn,ps40n.mab,ps40n.ui,dn,mab);
v=interp2(ps40n.dn,ps40n.mab,ps40n.vi,dn,mab);
w=interp2(ps40n.dn,ps40n.mab,ps40n.wi,dn,mab);

%griddata was acting weird - this is slow but gets the job done 
t=u.*nan; 
for i=1:length(dn)
    ii=findnearest_JACK(PS40N.datenum,dn(i));
    if abs(dn(i)-PS40N.datenum(ii)) < 0.000001
        t(:,i)=interp1(-PS40N.pres(ii,:)+40,PS40N.temp(ii,:),mab);
    end 
end
...
%% 
if 0
    save([anadir 'PS40N.mat'],'Usig','Vsig','Wsig','Tsig','dn_sig','H',...
        'u','v','w','t','dn','mab','subtidal','-v7.3');
    disp('PS40N.mat saved!');
end
