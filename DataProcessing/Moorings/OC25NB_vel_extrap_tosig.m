...
% % % according to the readme, its has been rotated 

%% Make mask for oc25nb 
perbad=15;
oc25nb.z=meshgrid(oc25nb.zab,oc25nb.datenum)';

oc25nb.maskjm=double(oc25nb.z<(25-(25*perbad/100)));
oc25nb.maskjm(oc25nb.maskjm==0)=nan;

%% Transform to uniform grid in z 
dn=datenum(2017,9,7,0,0,0):1/(24*60):datenum(2017,11,3,0,0,0);
mab=(0:0.5:26.5)'; 

u=interp2(oc25nb.datenum,oc25nb.zab,oc25nb.u.*oc25nb.maskjm,dn,mab);
v=interp2(oc25nb.datenum,oc25nb.zab,oc25nb.v.*oc25nb.maskjm,dn,mab);
w=interp2(oc25nb.datenum,oc25nb.zab,oc25nb.w.*oc25nb.maskjm,dn,mab);
...
clearvars -except dn mab EAST NORTH VERT oc25nb anadir
...
if 0
    save([anadir 'oc25nb_vel_zandsig.mat']);
end 
