...
PW5=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/PW5/ptsal_tchain_PW5.mat');
pw5=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/PW5/PW5_SIG_30.mat');

PW5.mab=PW5.TCHAIN.ZBEDT;
PW5.mab(1)=PW5.mab(2)+2;

%% Need to convert from local time to UTC!! 
% added this line 9/19/19 after disovering the times didn't make sense.
% whoops! 

PW5.TCHAIN.time_dnum30=PW5.TCHAIN.time_dnum30+(7/24); 
PW5.TCHAIN.time_dnum60=PW5.TCHAIN.time_dnum60+(7/24); 

pw5.SIG_30.time_dnum=pw5.SIG_30.time_dnum+(7/24); 

%% %% Transform to uniform grid in z 
% pcolorjw(PW5.TCHAIN.time_dnum30,PW5.TCHAIN.ZBEDT,PW5.TCHAIN.TEMP30')

dn=datenum(2017,9,1,0,0,0):1/(24*60):datenum(2017,10,19,0,0,0);
mab=(0:0.5:20)'; 

% there was surface data that wasn't flagged appropriately 
u=interp2(pw5.SIG_30.time_dnum,pw5.SIG_30.Zbed(1:33),pw5.SIG_30.Ue(:,1:33)',dn,mab);
v=interp2(pw5.SIG_30.time_dnum,pw5.SIG_30.Zbed(1:33),pw5.SIG_30.Un(:,1:33)',dn,mab);
t=interp2(PW5.TCHAIN.time_dnum30,PW5.mab,PW5.TCHAIN.TEMP30',dn,mab);
...
if 1
    ...
    '/Volumes/InnerShelf1/JackAnalysis/AlongShelfVariability/CleanUpMoorings/PW5_clean' ];

    save([anadir 'PW5.mat'],'Usig','Vsig','Tsig','dn_sig','H',...
        'u','v','t','dn','sig','mab','subtidal','Psig','Rho_sig','-v7.3');
    disp('PW5.mat saved!');
end
