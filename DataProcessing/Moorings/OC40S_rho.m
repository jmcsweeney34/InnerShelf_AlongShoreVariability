...
%% Download Data 
OC40S=load('/Volumes/InnerShelf1/JohannesProcessing/oc40s_t_30s.mat');
% OC40S=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/OC40S-T/OC40S-T_deploy1_30sec.mat');

tempo=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/OC40S-T/OC40S-T_deploy2_30sec.mat');
OC40S_b.lon=-tempo.grid30s.lon;
OC40S_b.lat=tempo.grid30s.lat;
OC40S_b.temp=tempo.grid30s.temp;
OC40S_b.mab=40-tempo.grid30s.pos;
OC40S_b.dn=tempo.grid30s.datenum;
...
Temp1=interp2(OC40S.dn,OC40S.mab,OC40S.temp,dn,mab);
Temp2=interp2(OC40S_b.dn,OC40S_b.mab,OC40S_b.temp,dn,mab);
...
figure; 
subplot(2,1,1);
pcolorjw(OC40S.dn,OC40S.mab,OC40S.temp); colorbar 
hold on 
pcolorjw(OC40S_b.dn,OC40S_b.mab,OC40S_b.temp); 
xaxis(dn(1),dn(end));
yaxis(mab(1),mab(end));
...
clearvars -except dn OC40S OC40S_b mab temp sal rho H sig Tsig Rho_sig dn_sig anadir D

if 0
    save([anadir 'OC40S_TempRho_zandsig.mat']);
end 
