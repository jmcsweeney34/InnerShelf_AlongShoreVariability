...
load('/Volumes/InnerShelf1/JackAnalysis/Moorings/ShowTwoTides/AlphaBeta/OC32N_TempRho_zandsig.mat');
...
if 0
    save([anadir 'oc32n_alpha_beta_Cw.mat']);
end 
