...
BW1=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/BW1/ptsal_tchain_BW1.mat');
bw1=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/BW1/BW1A_AQ.mat');

BW1.mab=BW1.TCHAIN.ZBEDT;
BW1.mab(1)=BW1.mab(2)+1.5;

%% Need to convert from local time to UTC!! 
% added this line 9/19/19 after disovering the times didn't make sense.
% whoops! 

BW1.TCHAIN.time_dnum30=BW1.TCHAIN.time_dnum30+(7/24); 
BW1.TCHAIN.time_dnum60=BW1.TCHAIN.time_dnum60+(7/24); 

bw1.AQ.time_dnum=bw1.AQ.time_dnum+(7/24); 

%% %% Transform to uniform grid in z 
% pcolorjw(BW1.TCHAIN.time_dnum30,BW1.TCHAIN.ZBEDT,BW1.TCHAIN.TEMP30')

dn=datenum(2017,9,1,0,0,0):1/(24*60):datenum(2017,10,18,0,0,0);
mab=(0:0.5:16)'; 

u=interp2(bw1.AQ.time_dnum,bw1.AQ.Zbed,bw1.AQ.Ue',dn,mab);
v=interp2(bw1.AQ.time_dnum,bw1.AQ.Zbed,bw1.AQ.Un',dn,mab);
t=interp2(BW1.TCHAIN.time_dnum30,BW1.mab,BW1.TCHAIN.TEMP30',dn,mab);
...
D=interp1(tide.dn,tide.wl+16,dn);
D=pl33tn(D,1/60,2)';
...
if 0
    ...
    '/Volumes/InnerShelf1/JackAnalysis/AlongShelfVariability/CleanUpMoorings/BW1_clean' ];

    save([anadir 'BW1.mat'],'Usig','Vsig','Tsig','dn_sig','H',...
        'u','v','t','dn','sig','mab','Psig','Rho_sig','subtidal','-v7.3');
    disp('BW1.mat saved!');
end
