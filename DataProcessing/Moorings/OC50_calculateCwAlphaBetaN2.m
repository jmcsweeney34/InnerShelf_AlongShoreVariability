...
load('/Volumes/InnerShelf1/JackAnalysis/Moorings/ShowTwoTides/AlphaBeta/OC50TempRho_zandsig.mat');
x=load('/Volumes/InnerShelf1/JackAnalysis/Moorings/ShowTwoTides/AlphaBeta/cleanup/MS100.mat');
Tsig=x.Tsig;
% dn=dn_sig(1,:);
...
if 0
    save([anadir 'oc50_alpha_beta_Cw.mat']);
end 
