...
load('/Volumes/InnerShelf1/JackAnalysis/Moorings/ShowTwoTides/AlphaBeta/OC17S_TempRho_zandsig.mat');
...
if 0
    save([anadir 'oc17s_alpha_beta_Cw.mat']);
end 
