...
load('/Volumes/InnerShelf1/JackAnalysis/Moorings/ShowTwoTides/AlphaBeta/OC25NA_TempRho_zandsig.mat');
...
if 0
    save([anadir 'oc25na_alpha_beta_Cw.mat']);
end 
