...
oc25sa_b=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/OC25SA-A/OC25SA-ADeploy2.mat');

%% Make mask for oc25sa 
perbad=15;
oc25sa.A.z=meshgrid(oc25sa.A.zab,oc25sa.A.datenum)';
oc25sa.A.maskjm=double(oc25sa.A.z<(25-(25*perbad/100)));
oc25sa.A.maskjm(oc25sa.A.maskjm==0)=nan;
oc25sa.A.maskjm(:,oc25sa.A.datenum<datenum(2017,9,9,0,0,0))=nan;

i=findnearest_JACK(oc25sa.A.datenum,736946.847468955);
oc25sa.A.u(:,1:i)=nan;
oc25sa.A.v(:,1:i)=nan;
oc25sa.A.w(:,1:i)=nan;

oc25sa_b.A.z=meshgrid(oc25sa_b.A.zab,oc25sa_b.A.datenum)';
oc25sa_b.A.maskjm=double(oc25sa_b.A.z<(25-(25*perbad/100)));
oc25sa_b.A.maskjm(oc25sa_b.A.maskjm==0)=nan;
...
u1=interp2(oc25sa.A.datenum,oc25sa.A.zab,oc25sa.A.u.*oc25sa.A.maskjm,dn,mab);
u2=interp2(oc25sa_b.A.datenum,oc25sa_b.A.zab,oc25sa_b.A.u.*oc25sa_b.A.maskjm,dn,mab);

u=u1.*nan;
i=~isnan(u1); u(i)=u1(i);
i=~isnan(u2); u(i)=u2(i);

v1=interp2(oc25sa.A.datenum,oc25sa.A.zab,oc25sa.A.v.*oc25sa.A.maskjm,dn,mab);
v2=interp2(oc25sa_b.A.datenum,oc25sa_b.A.zab,oc25sa_b.A.v.*oc25sa_b.A.maskjm,dn,mab);
v=v1.*nan;
i=~isnan(v1); v(i)=v1(i);
i=~isnan(v2); v(i)=v2(i);

w1=interp2(oc25sa.A.datenum,oc25sa.A.zab,oc25sa.A.w5.*oc25sa.A.maskjm,dn,mab);
w2=interp2(oc25sa_b.A.datenum,oc25sa_b.A.zab,oc25sa_b.A.w5.*oc25sa_b.A.maskjm,dn,mab);
w=w1.*nan;
i=~isnan(w1); w(i)=w1(i);
i=~isnan(w2); w(i)=w2(i);
...
clearvars -except dn mab EAST NORTH VERT oc25sa oc25sa_b anadir
...
if 0
    save([anadir 'oc25sa_vel_zandsig.mat']);
end 
