...
NRL50N=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/NRL50N/T.mat');
nrl50n=load('/Volumes/InnerShelf1/Moorings/NPS_SIO_Moorings/NRL50N/NRL50N_1min.mat');

%% Fix NRL temp - 50N  

NRL50N.dn=datenum(2017,9,6):60/(24*60*60):datenum(2017,11,2);
NRL50N.mab=flipud(NRL50N.T.zab);

NRL50N.temp(1:length(NRL50N.mab),1:length(NRL50N.dn))=nan;
NRL50N.temp(1,:)=interp1(datenum(NRL50N.T.datenum.z2),NRL50N.T.temp.z2,NRL50N.dn);
NRL50N.temp(2,:)=interp1(datenum(NRL50N.T.datenum.z3),NRL50N.T.temp.z3,NRL50N.dn);
NRL50N.temp(3,:)=interp1(datenum(NRL50N.T.datenum.z6),NRL50N.T.temp.z6,NRL50N.dn);
NRL50N.temp(4,:)=interp1(datenum(NRL50N.T.datenum.z9),NRL50N.T.temp.z9,NRL50N.dn);
NRL50N.temp(5,:)=interp1(datenum(NRL50N.T.datenum.z15),NRL50N.T.temp.z15,NRL50N.dn);
NRL50N.temp(6,:)=interp1(datenum(NRL50N.T.datenum.z18),NRL50N.T.temp.z18,NRL50N.dn);
NRL50N.temp(7,:)=interp1(datenum(NRL50N.T.datenum.z21),NRL50N.T.temp.z21,NRL50N.dn);
NRL50N.temp(8,:)=interp1(datenum(NRL50N.T.datenum.z24),NRL50N.T.temp.z24,NRL50N.dn);
NRL50N.temp(9,:)=interp1(datenum(NRL50N.T.datenum.z27),NRL50N.T.temp.z27,NRL50N.dn);
NRL50N.temp(10,:)=interp1(datenum(NRL50N.T.datenum.z30),NRL50N.T.temp.z30,NRL50N.dn);
NRL50N.temp(11,:)=interp1(datenum(NRL50N.T.datenum.z33),NRL50N.T.temp.z33,NRL50N.dn);
NRL50N.temp(12,:)=interp1(datenum(NRL50N.T.datenum.z36),NRL50N.T.temp.z36,NRL50N.dn);
NRL50N.temp(13,:)=interp1(datenum(NRL50N.T.datenum.z39),NRL50N.T.temp.z39,NRL50N.dn);
NRL50N.temp(14,:)=interp1(datenum(NRL50N.T.datenum.z42),NRL50N.T.temp.z42,NRL50N.dn);
NRL50N.temp(15,:)=interp1(datenum(NRL50N.T.datenum.z50),NRL50N.T.temp.z50,NRL50N.dn);

% % clever way to identify good data; but want bad data haha 
% i=(NRL50N.dn>datenum(2017,9,9,18,1,0)).*(NRL50N.dn<datenum(2017,10,31,3,0,0));
% i(i==0)=nan;

i=find(NRL50N.dn<datenum(2017,9,9,18,1,0) | NRL50N.dn>datenum(2017,10,31,3,0,0));

NRL50N.dn(i)=[];
NRL50N.temp(:,i)=[];

%% Get rid of bad ADCP data - NRL50 
i=find(nrl50n.A.datenum<datenum(2017,9,9,18,5,0) | nrl50n.A.datenum>datenum(2017,10,31,15,0,0));
...
perbad=10;
i=find(nrl50n.A.zab>(max(nrl50n.A.zab)-max(nrl50n.A.zab)*perbad/100));
nrl50n.A.u(i,:)=nan;
nrl50n.A.v(i,:)=nan;
nrl50n.A.w5(i,:)=nan;
...
u=interp2(nrl50n.A.datenum,nrl50n.A.zab,nrl50n.A.u,dn,mab);
v=interp2(nrl50n.A.datenum,nrl50n.A.zab,nrl50n.A.v,dn,mab);
w=interp2(nrl50n.A.datenum,nrl50n.A.zab,nrl50n.A.w5,dn,mab);
t=interp2(NRL50N.dn,NRL50N.mab,NRL50N.temp,dn,mab);
...
%% 
if 0
    save([anadir 'NRL50N.mat'],'Usig','Vsig','Wsig','Tsig','Rho_sig','Psig','dn_sig','H',...
        'u','v','w','t','dn','mab','sig','subtidal','-v7.3');
    disp('NRL50N.mat saved!');
end
