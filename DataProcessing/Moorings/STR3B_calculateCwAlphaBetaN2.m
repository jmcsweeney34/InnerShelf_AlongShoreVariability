...
load('/Volumes/InnerShelf1/JackAnalysis/Moorings/ShowTwoTides/AlphaBeta/STR3B_TempRho_zandsig.mat');
...
title ('Cw');
legend([h1 h3],'OC10','0C50');
xaxis(X.DNrho(1),X.DNrho(end));
...
if 0
    save([anadir 'str3b_alpha_beta_Cw.mat']);
end 
