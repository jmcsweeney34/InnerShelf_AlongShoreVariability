...
load('/Volumes/InnerShelf1/JackAnalysis/Moorings/ShowTwoTides/AlphaBeta/OC25SB_TempRho_zandsig.mat');
...
Rho_sig=fillmissing(Rho_sig,'linear');
...
if 0
    save([anadir 'oc25sb_alpha_beta_Cw.mat']);
end 
