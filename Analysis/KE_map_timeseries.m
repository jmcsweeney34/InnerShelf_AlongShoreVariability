...
% analysis directory
anadir= '/Volumes/InnerShelf1/JackAnalysis/AlongShelfVariability/JPOmanuscript/KineticEnergy/';
...
set(leg,'Position',[0.159580014409216         0.459380008172759         0.115994236311239         0.108377659574468],...
    'edgecolor','k','fontsize',10);
% set(gca,'fontweight','bold','fontsize',12,'xtick',dn1:dt:dn2,'xticklabels',datestr(dn1:dt:dn2,'mm/dd'),...
%     'box','on','layer','top','ytick',-0.02:0.01:0.02,'yticklabels',-0.02:0.01:0.02);
set(gca,'fontweight','bold','fontsize',12,'xtick',dn1:dt:dn2,'xticklabels',datestr(dn1:dt:dn2,'mm/dd'),...
    'box','on','layer','top','ytick',-0.04:0.02:0.06,'yticklabels',-0.04:0.02:0.06);
grid on; hh=gca; hh.XMinorGrid='on'; 
...
axes(hax(1))
plot(OC50.dn,ke_sd.OC50,'k','linewidth',1); yaxis(0,50);xaxis(dn1,dn2);
set(gca,'fontweight','bold','fontsize',12,'xtick',dn1:dt:dn2,'xticklabels',[],...
...
axes(hax(2))
plot(NRL50N.dn,ke_sd.NRL50N,'r','linewidth',1);yaxis(0,50);xaxis(dn1,dn2);
set(gca,'fontweight','bold','fontsize',12,'xtick',dn1:dt:dn2,'xticklabels',[],...
    'box','on','layer','top','ytick',15:15:45,...
    'TickDir', 'both','TickLength',[0.0075 0.0075]);
grid on
...
axes(hax(3))
plot(PS50.dn,ke_sd.PS50,'color',hex2rgb('#1682E0'),'linewidth',1);yaxis(0,50);xaxis(dn1,dn2);
set(gca,'fontweight','bold','fontsize',12,'xtick',dn1:dt:dn2,'xticklabels',[],...
    'box','on','layer','top','ytick',15:15:45,...
    'TickDir', 'both','TickLength',[0.0075 0.0075]);
grid on
...
axes(hax(4))
plot(VB50N.dn,ke_sd.VB50N,'color',hex2rgb('#45C162'),'linewidth',1);yaxis(0,50);xaxis(dn1,dn2);
set(gca,'fontweight','bold','fontsize',12,'xtick',dn1:dt:dn2,'xticklabels',[],...
    'box','on','layer','top','ytick',15:15:45,...
    'TickDir', 'both','TickLength',[0.0075 0.0075]);
grid on
...
axes(hax(5))
plot(VB50S.dn,ke_sd.VB50S,'color',[0.7 0.7 0.7],'linewidth',1);yaxis(0,50);xaxis(dn1,dn2);
set(gca,'fontweight','bold','fontsize',12,'xtick',dn1:dt:dn2,'xticklabels',[],...
    'box','on','layer','top','ytick',15:15:45,...
    'TickDir', 'both','TickLength',[0.0075 0.0075]);
grid on
...
axes(hax(6))
plot(NRL50S.dn,ke_sd.NRL50S,'color',hex2rgb('#FF9456'),'linewidth',1);yaxis(0,50);xaxis(dn1,dn2);
...
if 0
set(gcf,'PaperPositionMode','auto');
    print(gcf,'-dpng','-r300',[anadir 'KEsd_timeseries91719']);
end 
